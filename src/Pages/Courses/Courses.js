    ...
    <div className='shadow-lg'>
      ...
      <div className={`mx-auto px-12 md:px-24 shadow-2xl bg-white border-none p-20 ${pathname === "courses" ? "" : "pt-16"}`}>
        ...
        <div className='grid grid-cols-4 mt-8 text-center gap-2 md:gap-8 lg:gap-12'>
          {
            pathname === "courses" ? <button className='btn btn-primary'>All</button> : ""
          }
          <p className="btn btn-primary text-[11px]">Computer Programming</p>
          <p className="btn btn-primary text-[11px]">Artificial Intelligence</p>
          <p className="btn btn-primary text-[11px]">Game Development</p>
          <p className="btn btn-primary text-[11px]">Management</p>
          <p className="btn btn-primary text-[11px]">Art</p>
          <p className="btn btn-primary text-[11px]">Digital Marketing</p>
