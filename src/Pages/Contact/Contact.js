...
const Contact = () => {
    ...
    return (
        <div className="hero min-h-screen px-6 py-14 sm:px-8 md:px-14 mx-auto shadow bg-white">
            <div className='lg:px-20 mx-auto'>
                <div className='space-y-8'>
                    <h1 className="text-2xl mt-12 md:mt-0 md:text-3xl font-bold text-blue-500 text-center pb-10">Contact Us</h1>
