            ...
            <div className="hero min-h-screen px-6 sm:px-8 md:px-14 mx-auto pb-12 bg-white shadow-2xl">
                <div className="flex flex-col lg:flex-row-reverse">
                    ...
                    <div className='lg:pr-20 md:mt-12 mx-auto'>
                        <div>
                            <h1 className="text-3xl sm:text-5xl mt-12 md:mt-0 font-bold text-black">Large educational programs</h1>
                        ...
                        <div className='flex space-x-10 mt-12'>
                            <button className="btn text-black bg-gradient-to-r from-green-400 to-blue-500 border-none">Try for free</button>
                            <button className="btn text-black btn-outline border-orange-400 hover:bg-gradient-to-r from-pink-500 to-yellow-500">See Pricing plans</button>
                        </div>
                    </div>
                </div>
            </div>
