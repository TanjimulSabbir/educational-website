...
const HowWork = () => {
    ...
    return (
        <div>
            <div className="hero min-h-screen px-6 sm:px-8 md:px-14 mx-auto pb-14 shadow-2xl bg-blue-100">
                <div className="flex flex-col-reverse lg:flex-row lg:space-x-8">
                    <div className='md:mt-12 mx-auto flex-1 text-black
                    '>
                    ...
                    <div className="rounded-lg w-full mt-14 lg:mt-0 flex-1 shadow-2xl bg-white">
